...
/*   Updated: 2020/07/25 19:39:57 by yunslee          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				matchup_tag(char *tag_s, va_list *ap, t_specifier *matcharray);
...
void			when_d_left_zero(char *int_str, t_flag *flag,
								int precision_zero, int width_space);
...
char			*return_address_str(t_flag *flag, va_list *ap,
										char *hexa_table);
...
int				big_x_specifier(char *s, va_list *ap);
